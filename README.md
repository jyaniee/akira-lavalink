...
- **2025년 5월 기준, 롤 전적 검색 기능이 추가되었습니다.** Riot API를 연동하여 소환사의 랭크, 레벨, 모스트 챔피언 정보를 디스코드 임베드로 제공합니다.<br>
- **2025년 9월 기준, 메이플스토리 정보 검색, 경험치 히스토리 기능이 추가되었습니다.** NEXON Open API를 연동하여 유저의 닉네임, 레벨, 경험치 등의 정보를 디스코드 임베드로 제공합니다.
## 주요 기능
...
| `/메이플 기본`     | 메이플스토리 닉네임을 입력하여 해당 유저의 기본 정보를 조회합니다. | `/메이플 기본 닉네임: 심하이` |
| `/메이플 경험치`     | 메이플스토리 닉네임을 입력하여 최근 7일간의 경험치 변화를 확인합니다. | `/메이플 경험치 닉네임: 심하이` |
